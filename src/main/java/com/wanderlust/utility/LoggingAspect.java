package com.wanderlust.utility;
...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.wanderlust.dao.*Impl.*(..))", throwing = "exception")
	public void logExceptionFromDAO(Exception exception)throws Exception{
		log(exception);
	}
	
	@AfterThrowing(pointcut = "execution(* com.wanderlust.service.*Impl.*(..))", throwing = "exception")	
